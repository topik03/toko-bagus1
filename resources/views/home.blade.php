...
@section('content')
<!-- Hero Section -->
<section class="bg-gradient-to-r from-green-500 to-emerald-600 text-white py-12 mb-8 rounded-lg">
    <div class="container mx-auto px-4 text-center">
        ...
        <a href="{{ route('products.catalog') }}"
           class="bg-white text-green-600 px-8 py-3 rounded-full font-semibold hover:bg-gray-100 transition">
